...
/^STAT Read L1 time:/ {if ($6 == 0) Read_L1_time[numprocs] = 0; else Read_L1_time[numprocs] = $8 * exec[numprocs];}
/^STAT Read L2 time:/ {if ($6 == 0) Read_L2_time[numprocs] = 0; else Read_L2_time[numprocs] = $8 * exec[numprocs];}
/^STAT Read localmem time:/ {if ($6 == 0) Read_localmem_time[numprocs] = 0; else Read_localmem_time[numprocs] = $8 * exec[numprocs];}
/^STAT Read remotemem time:/ {if ($6 == 0) Read_remotemem_time[numprocs] = 0; else Read_remotemem_time[numprocs] = $8 * exec[numprocs];}
/^STAT Write L1 time:/ {if ($6 == 0) Write_L1_time[numprocs] = 0; else Write_L1_time[numprocs] = $8 * exec[numprocs];}
/^STAT Write L2 time:/ {if ($6 == 0) Write_L2_time[numprocs] = 0; else Write_L2_time[numprocs] = $8 * exec[numprocs];}
/^STAT Write localmem time:/ {if ($6 == 0) Write_localmem_time[numprocs] = 0; else Write_localmem_time[numprocs] = $8 * exec[numprocs];}
/^STAT Write remotemem time:/ {if ($6 == 0) Write_remotemem_time[numprocs] = 0; else Write_remotemem_time[numprocs] = $8 * exec[numprocs];}
/^STAT RMW L1 time:/ {if ($6 == 0) RMW_L1_time[numprocs] = 0; else RMW_L1_time[numprocs] = $8 * exec[numprocs];}
/^STAT RMW L2 time:/ {if ($6 == 0) RMW_L2_time[numprocs] = 0; else RMW_L2_time[numprocs] = $8 * exec[numprocs];} 
/^STAT RMW localmem time:/ {if ($6 == 0) RMW_localmem_time[numprocs] = 0; else RMW_localmem_time[numprocs] = $8 * exec[numprocs];} 
/^STAT RMW remotemem time:/ {if ($6 == 0) RMW_remotemem_time[numprocs] = 0; else RMW_remotemem_time[numprocs] = $8 * exec[numprocs];} 
