...
#ifndef _prefetch_h_
#define _prefetch_h_ 1

void L2ExclPrefetch(void *);
void L2ShPrefetch(void *);
void ExclPrefetch(void *);
void ShPrefetch(void *);

#define PREFETCHX_STRUCT(X,Y) { \
                                    int *prefptr; \
                                    int *end; \
                                    prefptr = (int*) (X); \
                                    end = ((char*) prefptr) + (Y); \
                                    while (prefptr<end) { \
					 ExclPrefetch(prefptr); \
                                         prefptr += 16; \
                                    } \
                            }


#define PREFETCH_STRUCT(X,Y) { \
                                    int *prefptr; \
                                    int *end; \
                                    prefptr = (int*) (X); \
                                    end = ((char*) prefptr) + (Y); \
