      ...
      register FILE *s AND CONST char *format AND va_list args)
{
  ...
  if (s == (FILE *)(&__iob[0]))
    s = stdin;
  else if (s == (FILE *)(&__iob[1]))
    s = stdout;
  else if (s == (FILE *)(&__iob[2]))
    s = stderr;
...
#define	is_longlong	is_long_double
	...
	function = (printf_function*) NULL;
      else
	function = __printf_function_table[fc];
      /*      function = (printf_function *)(__printf_function_table == NULL ? NULL :
